...
public class RectangleController {
    ...
    //   called for GET requests by URL ("/rectangle/test").
    //   curl -X GET localhost:8080/rectangle/test
    @GetMapping("test")
    ...
    //   curl -X POST localhost:8080/rectangle/add -H 'Content-Type: application/json' -d '{"x":40,"y":20,"width":70,"height":30,"color":"purple"}'
    @PostMapping("add")
    ...
    //  curl -X GET localhost:8080/rectangle/getList
    @GetMapping("getList")
    public List<Rectangle> getRectangleList() {
        return rectangles;
    }

    //  curl -X GET localhost:8080/rectangle/getSVG
    @GetMapping("getSVG")
    ...
    //    for GET requests by URL ("/rectangle/getRectangle?index=my_index").
    //    curl -X GET "localhost:8080/rectangle/getRectangle?index=my_index"
    ...
    //    curl -X PUT "localhost:8080/rectangle/modify?index=my_index" -H 'Content-Type: application/json' -d '{"x":120,"y":100,"width":120,"height":60,"color":"green"}'
    @PutMapping("modify")
